...
class Ikbem_model extends CI_Model {
    ...
    public function add()
    {
        ...
        $namaKandidat = $this->input->post('txtNamaKandidat');
            ...
            } else if($this->db->simple_query("INSERT INTO komentar_bem(nama_pengomentar, nim_pengomentar, email_pengomentar, gambar, tanggal, komentar, id_kandidat, nama_kandidat)
    ...
    public function add2()
    {
        ...
        $namaKandidat = $this->input->post('txtNamaKandidat');
            ...
            } else if($this->db->simple_query("INSERT INTO reply_bem(nama_pembalas, nim_pembalas, email_pembalas, gambar, tanggal, balasan, nim_pengomentar, id_komentar, id_kandidat, nama_kandidat)
    ...
    public function hapuskomentar()
    {
        $id = $this->input->post('txtIdHapusKomentar');
            ...
            if($this->db->simple_query("DELETE FROM komentar_bem WHERE id = '$id'")){       
                $data['msg'][0] = "hapus";
    ...
    public function hapusreply()
    {
        $id = $this->input->post('txtIdHapusReply');
            ...
            if($this->db->simple_query("DELETE FROM reply_bem WHERE id = '$id'")){       
                $data['msg'][0] = "hapus";
    ...
    public function komenpage($limit, $start)
    {
        ...
        return $this->db->get_where('komentar_bem',['id_kandidat' => $id ], $limit, $start)->result();
    }

    public function countAllRecord()
    {
        $id = $this->uri->segment(3);
        return $this->db->get_where('komentar_bem',['id_kandidat' => $id ])->num_rows();
    }
