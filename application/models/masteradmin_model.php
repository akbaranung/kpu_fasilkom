...
class Masteradmin_model extends CI_Model {
    ...
    {
        $i = 1;
        $user = $this->db->query("SELECT * from user WHERE role_id = 1");
        ...
        foreach($user->result() as $rowa) {
            ...
            <a href='masteradmin/detail/$rowa->id' class='tooltip-error' data-rel='tooltip' title='Detail' ><button class='btn btn-info ace-icon fa fa-user-circle'> Detail</button></a> 
            </center>";
