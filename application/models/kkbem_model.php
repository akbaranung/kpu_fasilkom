...
class Kkbem_model extends CI_Model {
    ...
    {
        $i = 1;
        $user = $this->db->query("SELECT * from komentar_bem");
    ...
    public function add()
    {
        ...
        $sql = "SELECT * FROM komentar_bem WHERE id ='$id'";
        $result =$this->db->query($sql);

        if ($result->num_rows() > 0){
            if($this->db->simple_query("UPDATE komentar_bem
