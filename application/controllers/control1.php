...
Class Control1 extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('control1_model');
        $am = $this->control1_model->akses();
    ...
    {
        echo $this->control1_model->getData();
    }
