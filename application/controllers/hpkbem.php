...
Class Hpkbem extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('hpkbem_model');
        $am = $this->hpkbem_model->akses();
    ...
    {
    	$data['title'] = 'Hasil Pemilihan Kandidat BEM';
		...
		$this->load->view('hpkbem_view', $data);
		$this->load->view('footeradmin', $data);
    }

    public function daftar_data()
    {
        echo $this->hpkbem_model->getData();
    }
