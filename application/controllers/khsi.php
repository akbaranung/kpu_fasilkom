...
Class Khsi extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('khsi_model');
        $am = $this->khsi_model->akses();
    ...
    public function ganti()
    {
        ...
        $img = $_FILES['img'];
        if($img = ''){} else {
            $config['upload_path'] = './kandidat/HIMSISFO/';
            ...
            if(!$this->upload->do_upload('img')){
                ...
                if(!$delete){
                    ...
                    unlink('./kandidat/HIMSISFO/'. $delete);
                }
            }
        }
        ...
        $this->db->where('id', $id);
        $this->db->update('data_himsisfo', $data);
