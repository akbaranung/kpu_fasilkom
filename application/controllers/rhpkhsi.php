...
Class Rhpkhsi extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('rhpkhsi_model');
        $am = $this->rhpkhsi_model->akses();
    ...
    {
    	$data['title'] = 'Report Hasil Pemilihan Kandidat Himsisfo';
		...
		$this->load->view('rhpkhsi_view', $data);
		$this->load->view('footeradmin', $data);
    }

    public function daftar_data()
    {
        echo $this->rhpkhsi_model->getData();
    }
