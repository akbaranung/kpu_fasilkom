...
Class Hpkdpm extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('hpkdpm_model');
        $am = $this->hpkdpm_model->akses();
    ...
    {
    	$data['title'] = 'Hasil Pemilihan Kandidat DPM';
		...
		$this->load->view('hpkdpm_view', $data);
		$this->load->view('footeradmin', $data);
    }

    public function daftar_data()
    {
        echo $this->hpkdpm_model->getData();
    }
