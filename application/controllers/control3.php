...
Class Control3 extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('control3_model');
        $am = $this->control3_model->akses();
    ...
    {
        echo $this->control3_model->getData();
    }
