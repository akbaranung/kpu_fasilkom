<div class="content-wrapper">
    ...
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
            ...
            <h3><strong>Total Peserta Aktif Yang Belum Memilih Kandidat DPM : <?= $golput['jumlah'];  ?></strong></h3>
...
$( "a.rhpkdpm" ).addClass( "active" );

    var myTable =$('#datatable').DataTable({
      "ajax": {
        type   : "POST",
        url    : "<?php echo base_url(); ?>rhpkdpm/daftar_data/",
        data   : function(d) {
    ...
    $('#datatable tbody').on( 'click', '.fa-trash-alt', function () { 
                    ...
                    console.log(id);
                    $.post( "<?php echo base_url(); ?>rhpkdpm/hapus/", { id:id  }, function( data ) {
                        obj = $.parseJSON(data);
                        $("#myModal3").modal('show');
                        if (obj.msg[0]=="hapus"){
     ...
     $('#btnSimpan').click(function(){
        ...
        $.post( "<?php echo base_url(); ?>rhpkdpm/add/", {
                type:1,
