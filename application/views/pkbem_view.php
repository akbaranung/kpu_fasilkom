    ...
    <section class="kandidat" id="kandidat">
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/komponen/pkbem.css'); ?>">
        ...
        <div class="container">
            <h2 class="title">Pemilihan Kanditat <strong>BEM</strong></h2>
            <div class="row mt-3">
                ...
                <div class="col-lg-4 mt-3 card">
                    <div class="kartu">
                        <div class="imgBx">
                            <img src="<?php echo base_url().'/kandidat/BEM/'.$k->img ;?>">
                        </div>
                        <div class="contentBx">
                            <h3><?= $k->no_urut; ?>. <?= $k->nama; ?></h3>
                            <h2 class="price">Kandidat BEM</h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="<?php echo base_url().'/kandidat/BEM/'.$k->img ;?>" class="rounded-circle" style="width: 250px; height:250px;">
...
$(document).ready(function() {
    $('#btnSimpan<?php echo $k->id; ?>').click(function(){
        ...
        $.post( "<?php echo base_url(); ?>pkbem/add/", {
                type:1,
