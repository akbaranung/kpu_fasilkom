<div class="content-wrapper">
    ...
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
            ...
            <h3><strong>Total Peserta Aktif Yang Belum Memilih Kandidat Himsisfo : <?= $golput['jumlah'];  ?></strong></h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-padding">
                <h5 class="modal-title" id="exampleModalLabel">Batalkan Suara</h5>
            ...
            <div class="modal-body">
                <form name="f_kategori" id="f_kategori" action="">
                    ...
                    <h2>Batalkan Suara Untuk Kandidat :<input id="txtKodePemilih" name="txtKodePemilih" style="border: 0; width: 100%; ">?</h2>
            </div>
            <div class="modal-footer">
                <button class="btn btn-white btn-info btn-bold" type="button" id="btnSimpan" name="btnSimpan">
                    <i class="ace-icon fa fa-save blue"></i> Batalkan</button>
...
$( "a.rhpkhsi" ).addClass( "active" );

    var myTable =$('#datatable').DataTable({
      "ajax": {
        type   : "POST",
        url    : "<?php echo base_url(); ?>rhpkhsi/daftar_data/",
        data   : function(d) {
    ...
    $('#datatable tbody').on( 'click', '.fa-trash-alt', function () { 
                    ...
                    console.log(id);
                    $.post( "<?php echo base_url(); ?>rhpkhsi/hapus/", { id:id  }, function( data ) {
                        obj = $.parseJSON(data);
                        $("#myModal3").modal('show');
                        if (obj.msg[0]=="hapus"){
     ...
     $('#datatable tbody').on( 'click', '.fa-window-close', function () {            
     ...
     $('#btnSimpan').click(function(){
        ...
        $.post( "<?php echo base_url(); ?>rhpkhsi/add/", {
                type:1,
