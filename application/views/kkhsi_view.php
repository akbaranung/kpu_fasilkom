                    ...
                    <table id="datatable" class="table table-striped table-bordered table-hover" style="width: 100%">
                        <thead>
                            <tr> 
                                ...
                                <th class="center" width="15%">Nama Asli Pengomentar</th>
                                <th class="center" width="5%">NIM Pengomentar</th>
                                <th class="center" width="15%">Email Pengomentar</th>
                                <th class="center" width="15%">Gambar Profil Pengomentar</th>
                                <th class="center" width="5%">Tanggal</th>
                                <th class="center" width="15%">Komentar</th>
                                <th class="center" width="5%">Id Kandidat</th>
                                <th class="center" width="10%">Nama Kandidat</th>
                                <th class="center" >
                                    Kontrol Data Komentar
                                </th>
                            </tr>
                        </thead>                    
                            <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-padding">
                <h5 class="modal-title" id="exampleModalLabel">Data Komentar</h5>
            ...
            <div class="modal-body">
                <form name="f_kategori" id="f_kategori" action="">
                    ...
                    <table class="table table-form">
                        <tr><td style="width: 25%">Nama Asli Pengomentar</td>
                            <td style="width: 75%">
                        ...
                        <tr><td style="width: 25%">Email Pengomentar</td>
                            <td style="width: 75%">
                        ...
                        <tr><td style="width: 25%">Komentar</td>
                            <td style="width: 75%">
                                <textarea type="text" class="form-control" name="txtIsiKomentar" id="txtIsiKomentar" rows="5" required></textarea>
                            </td>
                        </tr>
...
$( "li.komentar" ).addClass( "menu-open");
$( "a.komentar" ).addClass( "active" );
$( "a.kkhsi" ).addClass( "active" );

    var myTable =$('#datatable').DataTable({
      "ajax": {
        type   : "POST",
        url    : "<?php echo base_url(); ?>kkhsi/daftar_data/",
        data   : function(d) {
    ...
    $('#datatable tbody').on( 'click', '.fa-trash-alt', function () { 
                    var jawab;
                    obj= $(this).parents('tr');
                    id = myTable.row( $(this).parents('tr') ).data()[10];
                    
                    jawab=confirm("Apakah yakin untuk menghapus \n"+
                                    "Komentar: "+myTable.row( $(this).parents('tr') ).data()[1]+"?");
                      if (jawab==false){
                        exit();
                      }
                    
                    console.log(id);
                    $.post( "<?php echo base_url(); ?>kkhsi/hapus/", { id:id  }, function( data ) {
                        obj = $.parseJSON(data);
                        $("#myModal3").modal('show');
                        if (obj.msg[0]=="hapus"){
     ...
     $('#datatable tbody').on( 'click', '.fa-edit', function () {            
        ...
        $('#txtEmail').val(nama2);
        $('#txtDate').val(nama3);
        $('#txtIsiKomentar').val(nama4);
        $('#txtIdKandidat').val(nama5);
        $('#txtNamaKandidat').val(nama6);
     ...
     $('#btnSimpan').click(function(){
        ...
        $.post( "<?php echo base_url(); ?>kkhsi/add/", {
                type:1,
                ...
                txtDate:$('#txtDate').val(),
                txtIsiKomentar:$('#txtIsiKomentar').val(),
