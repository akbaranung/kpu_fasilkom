...
$( "a.menuaksescontrol" ).addClass( "active" );
    ...
    var myTable =$('#datatable').DataTable({
      "ajax": {
        type   : "POST",
        url    : "<?php echo base_url(); ?>menuaksescontrol/daftar_data9/",
        data   : function(d) {
    ...
    $('#datatable tbody').on( 'click', '.fa-trash-alt', function () { 
                    ...
                    console.log(id);
                    $.post( "<?php echo base_url(); ?>menuaksescontrol/hapus9/", { id:id  }, function( data ) {
                        obj = $.parseJSON(data);
                        $("#myModal3").modal('show');
                        if (obj.msg[0]=="hapus"){
    ...
    $('#datatable thead').on( 'click', '.fa-plus-square', function () {
     ...
     $('#btnSimpan').click(function(){
        ...
        $.post( "<?php echo base_url(); ?>menuaksescontrol/add9/", {
                type:1,
