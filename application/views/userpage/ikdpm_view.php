   <section class="kandidat" id="kandidat">
       <link rel="stylesheet" type="text/css" href="<?= base_url('assets/komponen/dpm.css'); ?>">
       ...
       <div class="container">
           <h2 class="title">Info Kanditat <strong>DPM</strong></h2>
           <div class="row mt-3">
                   ...
                   <div class="col-lg-4 mt-3">
                       <div class="kartu card">
                           <div class="box">
                               ...
                               <a href="<?php echo base_url('useridpm/detail/' . $k->id . '/index'); ?>" class="buy">Detail</a>
                               <div class="circle"></div>
                               <img src="<?php echo base_url() . '/kandidat/DPM/' . $k->img; ?>" class="product">
                           </div>
                       </div>
                   </div>
               <?php endforeach ?>
