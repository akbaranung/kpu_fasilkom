   <section class="kandidat" id="kandidat">
       <link rel="stylesheet" type="text/css" href="<?= base_url('assets/komponen/himti.css'); ?>">
       ...
       <div class="container">
           <h2 class="title">Info Kanditat <strong>HiMTI</strong></h2>
           <div class="row mt-3">
                   ...
                   <div class="col-lg-4 mt-3 card">
                       <div class="kartu">
                           <div class="box">
                               ...
                               <a href="<?php echo base_url('userihti/detail/' . $k->id . '/index'); ?>" class="buy">Detail</a>
                               <div class="circle"></div>
                               <img src="<?php echo base_url() . '/kandidat/HiMTI/' . $k->img; ?>" class="product">
                           </div>
                       </div>
                   </div>
               <?php endforeach ?>
